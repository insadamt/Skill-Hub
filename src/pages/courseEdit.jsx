...
const CourseEdit = () => {
  ...
  return (
    <main className="p-3 md:p-5 lg:p-6">
      <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold">Edit Course</h1>
        ...
        <section aria-label="Course Information" className="mt-3 md:mt-4 gap-3 md:gap-4 bg-gray-100/50 p-3 md:p-5 rounded-md">
          ...
          <div className="mt-2 md:mt-3">
            ...
            <input
              ...
              className={
                errors.title
                  ? "bg-gray-300/50 border border-red-500 p-2 w-full rounded text-sm md:text-base"
                  : "bg-gray-300/50 p-2 w-full rounded text-sm md:text-base"
              }
              value={inputs.title}
            ...
            />
            {errors.title ? (
              <p id="title-error" className="text-red-500 mt-1 text-sm">Title is Empty !</p>
            ) : null}
          </div>
          <div className="mt-2 md:mt-3">
            ...
            />
            {errors.description ? (
              <p id="description-error" className="text-red-500 mt-1 text-sm">Description is Empty !</p>
            ) : null}
          </div>
          <div className="mt-2 md:mt-3">
            ...
            />
            {errors.instructor ? (
              <p id="instructor-error" className="text-red-500 mt-1 text-sm">Instructor is Empty !</p>
            ) : null}
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:gap-5">
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-5">
              ...
              <div className="mt-2 md:mt-3">
                ...
                />
                {errors.studentsNumber ? (
                  <p id="students-error" className="text-red-500 mt-1 text-sm">
              ...
              <div className="mt-2 md:mt-3">
                ...
                />
                {errors.duration ? (
                  <p id="duration-error" className="text-red-500 mt-1 text-sm">
