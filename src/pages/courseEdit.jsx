import { SquareCheck, ChevronUp, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="h-full overflow-y-auto p-4 lg:p-6">
      ...
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl lg:text-4xl font-bold font-gabarito text-neutral-900 dark:text-neutral-50 mb-6 lg:mb-8">Edit Course</h1>
